...
export const meta = {
  title: 'Tree Felling',
  date: '2014-11-10',
  excerpt: 'At Responsive Day Out Oliver Reichenstein introduced the Container Model, a new means of information architecture that recalls the origins of the web.',
};
...
<Quote attribution={{ author: 'Nick Haley' }}>
...
<Quote
  attribution={{
    author: 'Vannevar Bush, As We Think',
  }}
>

  It affords an immediate step…to associative indexing, the basic idea of which
  is a provision whereby any item may be caused at will to select immediately and
  automatically another…The process of tying two items together is the important
  thing.
